...
const menus = [
    ...
    { name: 'Service Partner', path: '/service-partners', icon: '🤝', order: 5 },
    { name: 'Coupon/Discount', path: '/coupons', icon: '🎫', order: 6 },
    { name: 'Banner', path: '/banners', icon: '🖼️', order: 7 },
    { name: 'Review & Rating', path: '/reviews', icon: '⭐', order: 8 },
    { name: 'CMS', path: '/cms', icon: '📝', order: 9 },
    { name: 'Query', path: '/queries', icon: '❓', order: 10 },
    { name: 'Report', path: '/reports', icon: '📉', order: 11 },
    {
        name: 'Role',
        path: '/roles',
        icon: '🛡️',
